...
<table>
  ...
  <tr>
    <td><img src="docs/login-desktop.png" alt="Login Desktop" width="560"/></td>
    <td><img src="docs/login-mobile.png" alt="Login Mobile" width="220"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="docs/student-desktop.png" alt="Dashboard Aluno Desktop" width="560"/></td>
    <td><img src="docs/student-mobile.png" alt="Dashboard Aluno Mobile" width="220"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="docs/teacher-desktop.png" alt="Dashboard Professor Desktop" width="560"/></td>
    <td><img src="docs/teacher-mobile.png" alt="Dashboard Professor Mobile" width="220"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="docs/coordinator-desktop.png" alt="Dashboard Coordenador Desktop" width="560"/></td>
    <td><img src="docs/coordinator-mobile.png" alt="Dashboard Coordenador Mobile" width="220"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="docs/guardian-desktop.png" alt="Dashboard Responsável Desktop" width="560"/></td>
    <td><img src="docs/guardian-mobile.png" alt="Dashboard Responsável Mobile" width="220"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="docs/admin-desktop.png" alt="Dashboard Admin Desktop" width="560"/></td>
    <td><img src="docs/admin-mobile.png" alt="Dashboard Admin Mobile" width="220"/></td>
  </tr>
</table>
...
1. Faça fork ou upload deste repositório na Vercel
2. Em **Settings → Environment Variables**, adicione:
   - `VITE_SUPABASE_URL` → URL do seu projeto Supabase
   - `VITE_SUPABASE_ANON_KEY` → chave anon do seu projeto Supabase
3. O `vercel.json` já está configurado com os rewrites necessários — não é necessário alterar nada mais

> **Onde encontrar as chaves:** no painel do Supabase, acesse **Settings → API → Project API keys**.
